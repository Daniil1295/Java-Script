    ...
    <div className='container mx-auto'>
      <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
        ...
        <motion.div
          ...
          <h3 className='h3 mb-4 '>I am a freelance Frond-end developer with over 5 years of experience.</h3>
          <p className='mb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi ab atque
            cumque
            Perferendis.</p>
          {/* stats */}
